...
export default function ModeSelectScreen({ onClassic, onPractice, onMultiplayer, onBack }) {
  return (
      ...
      <View style={styles.content}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={onPractice}
            accessibilityLabel="Play practice mode with stopwatch"
          >
            <Text style={styles.buttonText}>Practice</Text>
            <Text style={styles.buttonDescription}>
              Track your time as you play
            </Text>
          </TouchableOpacity>
